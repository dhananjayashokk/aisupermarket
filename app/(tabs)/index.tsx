...
export default function HomeScreen() {
  ...
  const renderApiStoreCard = (store: ApiStore, index: number) => {
    ...
    const minimumOrder =
      store.minimumOrder ?? 80 + Math.floor(Math.random() * 40); // 80-120
    const deliveryFee =
      store.deliveryFee ?? 15 + Math.floor(Math.random() * 20); // 15-35
      ...
      >
        <View style={styles.apiStoreHeader}>
          <View style={styles.apiStoreInfo}>
            <Text
              style={[styles.apiStoreName, { color: colors.text }]}
              numberOfLines={1}
            >
              {store.name}
            </Text>
            <Text
              style={[styles.apiStoreLocation, { color: colors.textSecondary }]}
              numberOfLines={1}
            >
              {store.location}
            </Text>
        ...
        <View style={styles.apiStoreDetails}>
          <View style={styles.apiStoreDetailRow}>
            ...
            <Text
              style={[styles.apiStoreAddress, { color: colors.textTertiary }]}
              numberOfLines={2}
            >
              {store.address}
            </Text>
        ...
        <View
          style={[styles.apiStoreFooter, { borderTopColor: colors.border }]}
        >
    ...
    >
      ...
      <View style={styles.storeImageContainer}>
        ...
        {!store.isOpen && (
          ...
          >
            <Text
              style={[styles.closedOverlayText, { color: colors.textInverse }]}
            >
              Closed
            </Text>
          </View>
        ...
        {store.offers.length > 0 && (
          <View style={[styles.offerBadge, { backgroundColor: colors.accent }]}>
            <Text
              style={[styles.offerText, { color: colors.text }]}
              numberOfLines={1}
            >
              {store.offers[0]}
            </Text>
      ...
      <View style={styles.storeInfo}>
        ...
        <View style={styles.storeMetaRow}>
          <Text
            style={[styles.storeCategory, { color: colors.textSecondary }]}
            numberOfLines={1}
          >
            {store.category}
          </Text>
        ...
        <View style={styles.headerTop}>
          <View style={styles.locationContainer}>
            ...
            <View style={styles.locationInfo}>
              ...
              <Text
                style={[styles.locationText, { color: colors.textInverse }]}
              >
                Home - 560034
              </Text>
            </View>
      ...
      >
        ...
        <View style={styles.sectionHeader}>
          <Text style={[styles.sectionTitle, { color: colors.text }]}>
            Available Stores{" "}
            {apiStores.length > 0 ? `(${apiStores.length})` : ""}
          </Text>
        </View>
